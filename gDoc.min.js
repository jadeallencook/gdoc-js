...
// gDoc.js minified
window.gDoc=function(e,t){var n={layout:function(){function n(e){Tabletop.init({key:e,callback:o,simpleSheet:!1})}function o(e){e=e[t].elements[0];for(var n=Object.keys(e),o=Object.keys(e).map(function(t){return e[t]}),c=0;c<n.length;c++)if(n[c].indexOf(":")>-1){var l=n[c].substr(n[c].indexOf(":")+1),r=n[c].substr(0,n[c].indexOf(":"));r=document.querySelector('[gDoc="'+r+'"]'),r.setAttribute(l,o[c])}else{var r=document.querySelector('[gDoc="'+n[c]+'"]');r.innerHTML=o[c]}}n(e)},block:function(){function t(e){Tabletop.init({key:e,callback:o,simpleSheet:!1})}function o(e){if(e=e[l].elements,0==u)for(var t=0;t<e.length;t++)n.html(e,t,r,a,i);else for(var t=0;u>t;t++)n.html(e,t,r,a,i)}var c=e["public"],l=e.sheet,r=e.gDoc,i=e.columns,u=e.loop,a=e.html();t(c)},html:function(e,t,n,o,c){e=e[t];for(var l=0;l<c.length;l++){var r=c[l],i=e[r];o=o.replace(new RegExp("{{"+r+"}}","g"),i)}n=document.querySelector('[gDoc="'+n+'"]'),n.insertAdjacentHTML("beforeend",o)}};"object"==typeof e?n.block():n.layout()};